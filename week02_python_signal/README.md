# Week 02: Python and Communication Signal Basics

This week I learned:
- create and manipulate NumPy arrays using indexing, slicing, reshaping, and data types, and how they differ from Python lists
- generate random data, use broadcasting and vectorization, and simulate BPSK signals with AWGN
...
## Files
- day01_numpy_arrays.py:create, inspect, slice, reshape, and manipulate NumPy arrays
- day02_vectorized_bpsk.py: generate random bits, apply BPSK mapping, add AWGN, and detect received bits
